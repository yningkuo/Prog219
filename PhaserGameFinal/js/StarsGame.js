...
class StarsGame extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("sky", "assets/winter.png");
    ...
    create() {
        ...
        this.timedEvent = this.time.addEvent({ delay: 3000, callback: this.doSomething, callbackScope: this, repeat: 2 });
    ...
    doSomething = function () {
        var bomb = this.bombs.create(0, 16, "bomb");
        bomb.setBounce(1);
    ...
    collectStar(player, star,bomb) {
       ...
       this.sound.play();
        ...
        if(this.score > 110){
            this.scene.start("NinjaGame");  // jump to 2nd game scene with that key name
        }
